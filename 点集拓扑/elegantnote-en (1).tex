\documentclass[en,hazy,black,noraml,12pt]{elegantnote}
\input{command.tex}
...
\begin{proposition}[The completness of the product space]$\\$
...
\begin{proposition}[the properties of a linear and continous map]$\\$
