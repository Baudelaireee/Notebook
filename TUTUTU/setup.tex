...
\declaretheorem[style=plain, name=Lemma, numbered=yes, sibling=theoremplain]{lemmaplain}
\declaretheorem[style=plain, name=Example, numbered=yes, numberwithin=section]{exampleplain}


% Unnumbered (starred-style) versions for the "plain" theorem environments
\declaretheorem[style=plain, name=Theorem, numbered=no]{theoremplain*}
\declaretheorem[style=plain, name=Proposition, numbered=no]{propositionplain*}
\declaretheorem[style=plain, name=Corollary, numbered=no]{corollaryplain*}
\declaretheorem[style=plain, name=Definition, numbered=no]{definitionplain*}
