...
\declaretheorem[style=plain, name=Lemma, numbered=no, sibling=theoremplain]{lemmaplain*}
\declaretheorem[style=plain, name=Definition, numbered=no, sibling=theoremplain]{definitionplain*}
