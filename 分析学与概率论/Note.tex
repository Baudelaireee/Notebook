...
\begin{tikzcd}
    ...
    \arrow[Rightarrow, "{(e)}"', from=3-1, to=3-5]
    \arrow[Rightarrow, "{(f)}"', from=3-5, to=3-7]
\end{tikzcd}
...
Here we give a theortical application of law of large number. If \(X_1,X_2,X_3\) are independent, then 
